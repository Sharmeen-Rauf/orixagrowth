...
const features1 = [
  {
    ...
    description:
      "Data-backed campaigns designed to achieve clear, measurable business goals.",
    icon: "chart",
  },
  {
    title: "Creative Execution",
    description:
      "High-converting content and visuals focused on engagement and performance.",
    icon: "creative",
  },
  {
...
const iconMap = { chart: IconChart, creative: IconCreative, grid: IconGrid };

export default function FeaturesIllustrationSection() {
  return (
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-shrink-0 lg:w-[45%]">
            <div className="relative rounded-2xl border-2 border-orange-400 bg-gradient-to-br from-amber-100 to-orange-200 p-6 shadow-lg md:p-8">
              ...
              {/* Illustration placeholder: person + speech bubble */}
